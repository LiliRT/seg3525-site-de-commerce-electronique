...
},
{
    ...
    formats: ["Papier", "Numérique"],
    pages: 688,
    isbn: "978-2-0000-0031-8",
    price: 22.99,
    stock: 20,
    featured: true,
    rating: 4.9,
    description:
        "D'Artagnan rejoint les mousquetaires du roi et se retrouve mêlé à des intrigues politiques et des duels d'honneur."
},
{
    id: 32,
    ...
    formats: ["Papier"],
    pages: 640,
    isbn: "978-2-0000-0032-5",
    price: 21.99,
    stock: 12,
    featured: false,
    rating: 4.6,
    description:
        "Intrigues de cour et guerres de religion dans la France des Valois."
},
{
    id: 33,
    ...
    formats: ["Papier", "Numérique"],
    pages: 832,
    isbn: "978-2-0000-0033-2",
    price: 23.99,
    stock: 15,
    featured: true,
    rating: 4.8,
    description:
        "Quasimodo, Esmeralda et Claude Frollo s'entrelacent dans une tragédie au cœur de Paris médiéval."
},
{
    id: 34,
    ...
    formats: ["Papier", "Numérique"],
    pages: 352,
    isbn: "978-2-0000-0035-6",
    price: 18.99,
    stock: 22,
    featured: true,
    rating: 4.8,
    description:
        "Phileas Fogg parie qu'il peut faire le tour du monde en 80 jours, accompagné de son fidèle Passepartout."
},
{
    id: 35,
    ...
    formats: ["Papier"],
    pages: 640,
    isbn: "978-2-0000-0036-3",
    price: 20.99,
    stock: 14,
    featured: false,
    rating: 4.7,
    description:
        "Des naufragés tentent de survivre sur une île mystérieuse pleine de secrets."
},
{
    id: 36,
    ...
    formats: ["Papier", "Numérique"],
    pages: 288,
    isbn: "978-2-0000-0037-0",
    price: 17.99,
    stock: 16,
    featured: false,
    rating: 4.6,
    description:
        "Un scientifique découvre un moyen de devenir invisible, mais perd rapidement le contrôle de son expérience."
},
{
    id: 37,
    title: "Don Quijote de la Mancha (historieta)",
    author: "Adaptación libre de Miguel de Cervantes",
    genre: "Bande dessinée",
    language: "Espagnol",
    originalYear: 1605,
    editionYear: 2024,
    ...
    rating: 4.7,
    description:
        "Adaptación en formato de cómic de la obra clásica de Cervantes. Don Quijote y Sancho Panza viven aventuras caballerescas reinterpretadas en viñetas modernas."
},
{
    id: 38,
    ...
    formats: ["Papier", "Numérique"],
    pages: 320,
    isbn: "978-2-0000-0038-7",
    price: 19.99,
    stock: 17,
    featured: true,
    rating: 4.9,
    description:
        "Dix personnes sont invitées sur une île isolée et meurent une à une selon une étrange comptine."
},
{
    id: 39,
    title: "Le Corbeau et autres poèmes",
    author: "Edgar Allan Poe",
    genre: "Policier",
    language: "Français",
    originalYear: 1845,
    ...
    formats: ["Papier"],
    pages: 160,
    isbn: "978-2-0000-0039-4",
    price: 13.99,
    stock: 24,
    featured: false,
    rating: 4.5,
    description:
        "Recueil de poèmes sombres et gothiques explorant la mort, la perte et la folie."
},
{
    id: 40,
    title: "El Ingenioso Hidalgo Don Quijote en viñetas",
    author: "Adaptación anónima de Miguel de Cervantes",
    genre: "Bande dessinée",
    language: "Espagnol",
    originalYear: 1605,
    editionYear: 2024,
    ...
    rating: 4.6,
    description:
        "Adaptación en formato de historieta de las aventuras de Don Quijote y Sancho Panza, conservando el espíritu satírico y caballeresco de la obra original."
}
];
